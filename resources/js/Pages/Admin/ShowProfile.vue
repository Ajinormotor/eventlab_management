 ...
 <AdminDashboardLayout>
    ...
    <section class="flex flex-col gap-7 p-5">
      ...
      <div class="w-full rounded-lg shadow-sm min-h-[400px] flex flex-col gap-5 h-full p-2 md:p-5 bg-white">
        <h1 class="w-full py-4 border-b border-b-green-500 text-green-400 font-semibold text-xl">
          Account Information
        </h1>
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-5 pt-7">
          ...
          <TextInput label="First Name" name="first_name" v-model="form.first_name"
           icon="shield-user-line" color=" focus-within:outline-green-400 "/>
          <TextInput label="Last Name" name="last_name" v-model="form.last_name" icon="shield-user-line"
          color=" focus-within:outline-green-400 " />
          ...
          <div class="flex flex-col md:flex-row gap-5 items-center justify-between">
            ...
            <div class="w-full">
              <TextInput label="Phone Number" name="phone_no" placeholder="+234" 
              v-model="form.phone_no" icon="phone-line" type="text"   color=" focus-within:outline-green-400 "/>
            </div>
          </div>
          ...
          <PrimaryButton :disabled="form.processing" type="submit" color="bg-green-400" >
            Update
          </PrimaryButton>
        </form>
      </div>
