...
<DashboardHeading   :label="page.component" />
                ...
                <div class="w-full rounded-lg shadow-sm min-h-[400px] flex flex-col gap-5 h-full p-2 md:p-5 bg-white">
                    ...
                    <h1 class="w-full py-4 border-b border-b-indigo-500 text-indigo-600
                     ...
                     <div class="md:border-r border-indigo-500 max-w-[400px] w-full flex flex-col gap-2 pr-2">
                        <img alt="" 
                        :src="user.image
                        ? `/storage/${user.image}`
          ...
          <p class="opacity-70 text-[9px"> Email Address:</p>
           <h1 class="font-semibold">{{ user.email}} </h1>
                     ...
                     <div class=" w-full flex flex-col gap-5 p-4">
                        ...
                        <div class="flex items-center justify-between  border-b border-b-indigo-500">
                            <h1 class="w-full py-4  text-indigo-600
                            font-semibold text-xl"> About Me</h1>

                            <div class="flex gap-1 items-center">
                            <Link
                            :href="route('dashboard.user.show')">
                                <i class="ri-external-link-line text-xl text-indigo-500 font-bold cursor-pointer"></i>
                            </Link>
<div 
@click="handleDelete"
 class="">
