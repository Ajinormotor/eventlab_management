...
const sideNavLink = [
    { title: 'Dashboard', icon: 'dashboard-line', path: 'admin.index', id: '1' },
    { title: 'Event', icon: 'shopping-cart-line', path: 'admin.event', id: '2' },
    { title: 'Profile', icon: 'settings-line', path: 'admin.profile', id: '3' },
];
...
<template>
    ...
    <section class="flex max-h-screen bg-[#f9f9f9] relative">
        ...
        <div
            :class="[
                'bg-green-400 h-screen gap-6 transition-all duration-300 fixed flex flex-col  items-start ',
            ...
            <div class="flex justify-between items-center gap-3  md:h-[76px] shadow-sm  p-3">
                ...
                ">
                    ...
                    type="text"
                     ...
                     class="border-0 outline-none md:w-full bg-transparent text-green-600"
                     />
                     <i class="ri-search-2-line text-green-400"></i>
                </div>
