...
const defaultImage = '/storage/image/default-event-details-2.jpg';
...
<template>
  <section class="w-full flex items-center justify-center">
    <div class=" md:w-[500px] md:h-[150px] relative">
      <label for="image" class="rounded-full md:w-[150px] md:h-[120px] relative">
        <img 
          :src="preview" 
          alt="Profile Image"
